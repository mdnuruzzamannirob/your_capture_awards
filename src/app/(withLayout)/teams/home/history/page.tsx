  ...
  return (
    <section className="margin-user container space-y-6 py-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-sm">All matches played by your team</p>
      </div>
          ...
          {rows.map((match) => (
            ...
            >
              <div>
                ...
                <p className="text-muted-foreground mt-1 text-sm">vs {match.opponent_team.name}</p>
              </div>
              <StatusBadge
