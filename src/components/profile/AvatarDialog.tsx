...
import { useUpdateAvatarMutation } from '@/store/features/user/userApi';
...
export default function AvatarDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      {/* Dialog Content */}
      <DialogContent className="bg-background/95 border border-gray-700 backdrop-blur sm:max-w-[425px]">
        <DialogHeader>
