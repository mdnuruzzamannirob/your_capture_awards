    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6 py-12 text-center text-primary-foreground">
      <div className="flex w-full max-w-md flex-col items-center rounded-2xl border border-border bg-surface p-8 shadow-2xl">
        ...
        <div className="flex w-full flex-col gap-3 sm:flex-row">
          <Button
            onClick={onRetry}
            className="flex h-11 flex-1 items-center justify-center gap-2 bg-[#2995f3] font-bold text-primary-foreground transition-all duration-200 hover:bg-[#1a85e2]"
          >
          ...
          <Button
            asChild
            variant="outline"
            className="flex h-11 flex-1 items-center justify-center gap-2 border-border bg-transparent font-bold text-muted-foreground hover:border-zinc-500 hover:text-primary-foreground"
          >
            <Link href={backUrl}>
