...
const ProfileHeader = () => {
  ...
  return (
    <section className="bg-background text-foreground margin relative rounded-b-xl pb-5">
      {/* Background */}
      <div className="bg-surface-secondary text-muted-foreground relative h-40 w-full overflow-hidden sm:h-60 md:h-80">
        {!coverError && user?.cover ? (
          ...
          <div className="bg-surface-secondary text-muted-foreground flex h-full w-full items-center justify-center">
            <p>No cover photo</p>
          </div>
        )}
