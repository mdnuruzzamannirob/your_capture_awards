...
const ClosedContestCardSkeleton = () => {
  return (
    <div className="space-y-2 text-center">
      {/* Title Skeleton */}
      <Skeleton className="bg-surface-secondary mx-auto h-5 w-40" />
      ...
      <div className="border-border relative h-72 overflow-hidden rounded-xl border-2">
        ...
        <div className="absolute inset-0 flex flex-col justify-between">
          ...
          <div className="flex items-center gap-2 p-5">
            <Skeleton className="bg-surface-secondary h-12 w-12 rounded-full" />
            <Skeleton className="bg-surface-secondary h-4 w-32" />
          </div>
          ...
          <div className="flex w-full items-center justify-between bg-black/80 py-2 text-primary-foreground">
            ...
            <div className="border-primary flex h-12 flex-2 flex-col items-center justify-center border-r px-2">
              <Skeleton className="bg-surface-secondary h-4 w-28" />
            </div>

            <div className="flex h-12 flex-1 flex-col items-center justify-center px-2">
              <Skeleton className="bg-surface-secondary h-4 w-14" />
              <Skeleton className="bg-surface-secondary mt-1 h-3 w-10" />
            </div>
          </div>
        </div>
      </div>
...
export default ClosedContestCardSkeleton;
