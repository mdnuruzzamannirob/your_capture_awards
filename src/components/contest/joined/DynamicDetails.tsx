          ...
          <TabsContent value="prices" className="space-y-32">
            {contest?.isMoneyContest ? (
              ...
              <p className="mx-auto flex h-40 max-w-2xl items-center justify-center text-center">
                ...
                awarded, top photographers and photos will still receive recognition and accolades
                for their outstanding work. Keep participating and showcase your talent!
              </p>
            )}
          </TabsContent>
                      ...
                      <div key={index} className="space-y-5">
                        ...
                        <div className="flex items-center justify-between gap-5">
                          <div className="flex w-1/3 items-center gap-3">
                            {/* Avatar Skeleton */}
                            <Skeleton className="bg-black-2-600 h-24 w-24 rounded-full" />
                            <div className="min-w-0 space-y-1">
                              ...
                              <Skeleton className="bg-black-2-600 mt-1 h-6 w-20 rounded" />
                            </div>
                          </div>
                          ...
                          <div className="flex items-center justify-between gap-5">
                            ...
                            <div className="flex w-full items-center">
                              <div className="bg-black-2-500 -mr-5 flex h-12 w-full items-center justify-end rounded-l-full px-2">
                                <div
                                  className={cn(
                                    'bg-primary flex h-9 items-center rounded-l-full px-3',
                                  )}
